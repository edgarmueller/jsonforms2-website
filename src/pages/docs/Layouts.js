...
import {ApiLink, PropHeader} from '../../components/common';
...
const Layouts = () => (
  <DocPage>
    ...
    <Typography variant='body1'>
      ...
      like <Link to='/docs/uischema/controls' className='link'>Controls</Link> or other layouts
    ...
    <Typography variant='h2'>
      Horizontal Layout (<Link to={'/examples/layouts#horizontal-layout'} className='link'>Demo</Link>)
    </Typography>
    <Typography variant='body1'>
    ...
    <Typography
      ...
      id='vertical-layout'
    >
      Vertical Layout (<Link to={'/examples/layouts#vertical-layout'} className='link'>Demo</Link>)
    </Typography>
    <p>
    ...
    {/* GROUP */}
    <Typography variant='h2'>
      Group (<Link to={'/examples/layouts#group-layout'} className='link'>Demo</Link>)
    </Typography>
    <p>
