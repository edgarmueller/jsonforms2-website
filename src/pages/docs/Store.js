...
import PropHeader from "../../components/common/PropHeader";
...
const Store = () => (
  <DocPage>
    ...
    <Typography variant='body1'>
      ...
      the section on <Link to='/docs/custom-renderers' className='link'>Custom Renderers</Link>.
    </Typography>
    ...
    <Typography variant='body1'>
      ...
      about <Link to='/docs/custom-renderers' className='link'>Custom Renderers</Link> for an example
      how to use these.
    </Typography>
    ...
    <Typography variant='body1'>
      ...
      about <Link to='/docs/providing-uischemas' className='link'>Providing UISchemas</Link> for an example
